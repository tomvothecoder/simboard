...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["machine_id"],
            ["machines.id"],
            name=op.f("fk_simulations_machine_id_machines"),
        ),
        sa.ForeignKeyConstraint(
            ["parent_simulation_id"],
            ["simulations.id"],
            name=op.f("fk_simulations_parent_simulation_id_simulations"),
        ),
        sa.ForeignKeyConstraint(
            ["status"],
            ["status_lookup.code"],
            name=op.f("fk_simulations_status_status_lookup"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_simulations")),
        sa.UniqueConstraint("name", "version_tag", name="uq_simulation_name_version"),
    )
    op.create_index(
        op.f("ix_simulations_case_name"), "simulations", ["case_name"], unique=True
    )
    op.create_index(
        op.f("ix_simulations_git_hash"), "simulations", ["git_hash"], unique=False
    )
    op.create_index(
        op.f("ix_simulations_machine_id"), "simulations", ["machine_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["simulation_id"],
            ["simulations.id"],
            name=op.f("fk_artifacts_simulation_id_simulations"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_artifacts")),
    )
    op.create_index(
        op.f("ix_artifacts_simulation_id"), "artifacts", ["simulation_id"], unique=False
    )
    op.create_table(
        "external_links",
        sa.Column("simulation_id", sa.UUID(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["simulation_id"],
            ["simulations.id"],
            name=op.f("fk_external_links_simulation_id_simulations"),
            ondelete="CASCADE",
        ),
